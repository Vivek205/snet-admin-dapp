...
const GetDaemonEndpoint: React.FC<IProps> = (props): ReactElement => {
    ...
    <Card className={classes.card}>
      <CardContent>
        ...
        <Typography variant="h5" component="h2" className={classes.description}>
          Please provide the details of the daemon for which the configuration
          has to be modified.
        </Typography>
        <br />
        <br />
        ...
        <Typography>
          <StringInput
            ...
            description="Enter Daemon Endpoint"
          />
          <br />
        </Typography>
      </CardContent>
